...
//Se cambio el tamaño del canvas
    canvas.width = 700;
    canvas.height = 700;
    ...
    class Projectile{
        ...
        update(){
            this.x += this.speed;
            if (this.x > this.game.width * 1.8) {
                this.markedForDeletion = true;
            }
        }

        draw(context){
            //Se cambio el color de balas 
    ...
    class Player{
        ...
        //Se cambio el tiempo del player
        update(){
            this.y += this.speedY;
    ...
    class Game{
        constructor(width, height){
            ...
            this.gameOver = false;
            this.score = 0;
            //Se cambio el puntaje
            this.winningScore = 150;
            this.gameTime = 0;
            //Se cambio el tiempo limite del tiempo
